    ...
    return(
        <Grid container justify='center' xs={11} className={classes.root}>
            <Grid item xs={12} className={classes.avatarDiv}>
                <ProfileAvatar style={{ margin: 10,width: 60,height: 60,}}/>
                <div>
                    <Typography variant='title' className={classes.textHead}>عبدالرحمن طارق</Typography>
                    <Typography variant='subheading' className={classes.textMail}>myemail@gmail.com</Typography>
                </div>
            </Grid>
...
export default withStyles(styles)(UserPanelSettings);
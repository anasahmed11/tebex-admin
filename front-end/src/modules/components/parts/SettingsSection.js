        ...
        return(
            <MenuList >
                ...
                <Link to="/affiliate" className={classes.link}>
                    <MenuItem className={classes.menuItem}>
                        <ListItemIcon className={classes.icon}>
                            <img className={classes.iconImage} src="https://cdn4.iconfinder.com/data/icons/marketing-and-digital-marketing-1/32/business_marketing_advertising_affiliate_marketing-512.png" />
                        </ListItemIcon>
